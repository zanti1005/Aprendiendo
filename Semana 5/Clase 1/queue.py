...
#sacra valores de la última posición y agregarlos en la posición cero
#retirar valor del final de la lista
...
#sacar valores de la primera posición y agregarlos al final de la lista
#retirar valor del inicio de la lista
